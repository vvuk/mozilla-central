                ...
                line_t line, cc_features_t feature_id, cc_feature_data_t *data)
{
    ...
    pmsg->msg_id     = CC_MSG_CREATEOFFER;
    pmsg->src_id     = src_id;
    pmsg->call_id    = call_id;
    pmsg->line       = line;
    pmsg->feature_id = feature_id;
                ...
                line_t line, cc_features_t feature_id, string_t sdp, cc_feature_data_t *data)
{
    ...
    pmsg->msg_id     = CC_MSG_CREATEANSWER;
    pmsg->src_id     = src_id;
    pmsg->call_id    = call_id;
    pmsg->line       = line;
    pmsg->feature_id = feature_id;
...
{
    static const char fname[] = "cc_setlocaldesc";
    cc_feature_t *pmsg;
    cc_msgbody_info_t *msg_body;
    ...
    pmsg->msg_id     = CC_MSG_SETLOCALDESC;
    pmsg->src_id     = src_id;
    pmsg->call_id    = call_id;
    pmsg->line       = line;
    pmsg->feature_id = feature_id;
...
void cc_setremotedesc (cc_srcs_t src_id, cc_srcs_t dst_id, callid_t call_id, line_t line, 
                    cc_features_t feature_id, cc_jsep_action_t action, string_t sdp, cc_feature_data_t *data)
{
    static const char fname[] = "cc_setremotedesc";
    cc_feature_t *pmsg;
    cc_msgbody_info_t *msg_body;
    ...
    pmsg->msg_id     = CC_MSG_SETREMOTEDESC;
    pmsg->src_id     = src_id;
    pmsg->call_id    = call_id;
    pmsg->line       = line;
    pmsg->feature_id = feature_id;
...
{
    static const char fname[] = "cc_localdesc";
    cc_feature_t *pmsg;
    cc_msgbody_info_t *msg_body;
